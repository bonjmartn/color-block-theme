...
class ctabutton_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Call to Action Button', 'color-block-free' ), // Name
      array( 'description' => __( 'Drag me to the Front Page Button widget area', 'color-block-free' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( '', 'color-block-free' );
